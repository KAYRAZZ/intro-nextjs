  ...
  return (
    <div id="1" className="py-5">
      ...
      <div>
        ...
        <p>
          Les composants vous permettent de découper l’interface utilisateur en éléments indépendants et réutilisables, vous permettant ainsi de considérer chaque élément de manière isolée. Il possède sa propre logique et sa propre apparence. Un composant peut être aussi petit qu'une balise bouton ou aussi grand qu'une page entière. Une fois défini, un composant peut être réutilisé n'importe où dans votre application, ce qui favorise la cohérence et la maintenabilité du code. Par convention, ils sont placés dans le dossier <mark>components</mark> à l'intérieur du dossier <mark>app</mark>. <u>Ils doivent obligatoirement commencer par une majuscule.</u>
        </p>
  ...
  return (
    <button>Voici un bouton</button>
      ...
      <div id="2">
        ...
        <p>
          Les composants peuvent être utilisés dans d'autres composants. Voici une exemple, à partir du composant <mark>MonBouton</mark>.
        </p>
        <FormatToCode language="jsx">
