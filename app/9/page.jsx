    ...
    <button onClick={handleClick}>
      Aller clique ici
        ...
        <p>
          ...
          <br /><br />
          De plus, il est possible de passer des paramètres à la fonction appelée. <u>Une fonction fléchée est obligatoire dans ce cas-là, à l'intérieur du onClick, sinon le code sera directement exécuté au chargement de la page.</u> Voici un exemple :
        </p>
        <FormatToCode language="jsx">
          {`export default function Page() {
