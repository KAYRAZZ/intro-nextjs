...
export default function Page() {
  ...
  return (
    ...
    />
        ...
        <p>
          Dans cet exemple, nous avons utilisé <mark>useState</mark> pour créer une variable d'état <mark>value</mark> et une fonction pour la modifier <mark>setValue</mark>. Lorsque l'utilisateur change la valeur de l'élément <mark>input</mark>, la fonction fléchée est appelée et la valeur de l'élément est stockée dans la variable <mark>value</mark>.
        </p>
      </div>
    </div>
  );
